...
document.getElementById('section_Widgets--search').appendChild(geocoder.onAdd(map));
// Controls navigation (zoom, rotation) /////////////
let controlNavigation = new mapboxgl.NavigationControl();

document.getElementById('section_Widgets--cNavigation').appendChild(controlNavigation.onAdd(map));
// Controls navigation (zoom, rotation) /////////////
// Geolocate ////////////////////////////////////
...
document.getElementById('section_Widgets--geo').appendChild(geolocate.onAdd(map));
// Geolocate ////////////////////////////////////
